  ...
  return (
    <div className="relative z-10 pt-28 pb-24">
      <div className="max-w-4xl mx-auto px-6 text-left">
        <ScrollReveal>
          <h1 className="text-4xl font-extrabold text-text-primary mb-6 font-display">Terms & Conditions</h1>
        ...
        <ScrollReveal stagger={0.08}>
          <div className="space-y-6 text-text-secondary text-sm leading-relaxed">
            <section className="glass-card">
              <h2 className="text-lg font-bold text-text-primary mb-2 font-display">1. Candidate Advisory Agreement</h2>
            ...
            <section className="glass-card">
              <h2 className="text-lg font-bold text-text-primary mb-2 font-display">2. Placement Success Fee Structure</h2>
            ...
            <section className="glass-card">
              <h2 className="text-lg font-bold text-text-primary mb-2 font-display">3. Confidentiality & Data Use</h2>
